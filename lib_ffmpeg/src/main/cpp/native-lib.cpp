...
Java_org_mark_ffmpeg_FFUtils_urlProtocolInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
    av_register_all();
...
JNIEXPORT jstring JNICALL
Java_org_mark_ffmpeg_FFUtils_avFormatInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_org_mark_ffmpeg_FFUtils_avCodecInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_org_mark_ffmpeg_FFUtils_avFilterInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
Java_org_mark_ffmpeg_FFUtils_playVideo(JNIEnv *env, jclass type, jstring videoPath_,
                                                 jobject surface) {
